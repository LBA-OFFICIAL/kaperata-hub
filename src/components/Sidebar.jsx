...
import { 
  ...
  Bell, Heart, Camera, Search, CheckSquare, Database, LogOut, ShieldAlert 
} from 'lucide-react';

const Sidebar = ({ view, setView, logout, mobileMenuOpen, setMobileMenuOpen, isSystemAdmin }) => {
  // RESTORED: All custom LBA labels and IDs
  const menuItems = [
  ...
  return (
    <>
      {/* Mobile Backdrop */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-[#3E2723]/60 backdrop-blur-sm z-[60] md:hidden" onClick={() => setMobileMenuOpen(false)} />
      )}
